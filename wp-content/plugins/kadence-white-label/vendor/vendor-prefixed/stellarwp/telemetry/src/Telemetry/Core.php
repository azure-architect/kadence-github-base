...
namespace KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry;

use KadenceWP\KadenceWhiteLabel\StellarWP\ContainerContract\ContainerInterface;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Admin\Admin_Subscriber;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Admin\Resources;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Contracts\Data_Provider;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Data_Providers\Debug_Data;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Events\Event_Subscriber;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Exit_Interview\Template;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Last_Send\Last_Send;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Opt_In\Status;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Telemetry\Telemetry;
use KadenceWP\KadenceWhiteLabel\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \KadenceWP\KadenceWhiteLabel\StellarWP\ContainerContract\ContainerInterface
	 */
