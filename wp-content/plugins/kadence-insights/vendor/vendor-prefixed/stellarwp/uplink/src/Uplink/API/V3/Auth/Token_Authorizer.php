...
namespace KadenceWP\Insights\StellarWP\Uplink\API\V3\Auth;

use KadenceWP\Insights\StellarWP\Uplink\API\V3\Contracts\Client_V3;
use KadenceWP\Insights\StellarWP\Uplink\Traits\With_Debugging;
use WP_Error;
use WP_Http;

use function KadenceWP\Insights\StellarWP\Uplink\is_authorized;
